...
PROD_CONTAINER_NAME = overfero-model-prod-container

# ifeq (, $(shell which nvidia-smi))
# 	PROFILE = ci
# 	CONTAINER_NAME = overfero-model-ci-container
# 	SERVICE_NAME = app-ci
# else
PROFILE = dev
CONTAINER_NAME = overfero-model-dev-container
...
generate-final-config-local: up
	@$(DOCKER_COMPOSE_EXEC) python overfero/generate_final_config.py ${OVERRIDES} 

...
def choose_file_path(path: str) -> AbstractFileSystem:
...
def open_file(path: str, mode: str = "r") -> Any:
    file_system = choose_file_path(path)
...
def is_dir(path: str) -> bool:
    file_system = choose_file_path(path)
    is_directory: bool = file_system.isdir(path)
    return is_directory


def is_file(path: str) -> bool:
    file_system = choose_file_path(path)
    is_files: bool = file_system.isfile(path)
    return is_files

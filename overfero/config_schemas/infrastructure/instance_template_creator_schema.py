...
from overfero.infrastructure.instance_template_creator import VMType


@dataclass
class BootDiskConfig:
    project_id: str = "ubuntu-os-cloud"
    name: str = "ubuntu-2204-jammy-v20240319"
    size_gb: int = 50
...
class InstanceTemplateCreatorConfig:
    ...
    subnetwork: str = SI(
        "https://www.googleapis.com/compute/v1/projects/${.project_id}/regions/asia-southeast2/subnetworks/default"
    )
    ...
    labels: dict[str, str] = field(default_factory=lambda: {"project": "overfero"})
